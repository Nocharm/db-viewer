...
export const MESSAGES = {
  ...
  "verify.summary.title": { ko: "선택한 조합", en: "Selected pair" },
  "verify.summary.collapse": { ko: "접기", en: "Fold" },
  "verify.summary.expand": { ko: "펼쳐서 수정", en: "Edit" },
  "verify.nav.title": { ko: "검증 카드", en: "Verification steps" },
  "verify.nav.hint": {
    ko: "카드를 누르면 그 단계로 이동합니다",
    en: "Click a card to jump to that step",
  },
